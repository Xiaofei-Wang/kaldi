...
%  task=tasks{i1};
  weight_file=[weight_dir,'frame_AE-splice-0-1_nobeam_comb/weight/stream_weights.scp'];
  ...
  for job=76 
    ...
    outdir=['exp/dnn4_pretrain-dbn_dnn/decode_frame_AE-splice-0-1_nobeam_comb/post'];
    mkdir(outdir);
    outfilename=['exp/dnn4_pretrain-dbn_dnn/decode_frame_AE-splice-0-1_nobeam_comb/post/post.',num2str(job),'.txt'];
