...
%  task=tasks{i1};
  weight_file=[weight_dir,'frame_AE_20D_nobeam_comb/weight/stream_weights.scp'];
  ...
  for job=34 
    ...
    outdir=['exp/dnn4_pretrain-dbn_dnn/decode_frame_AE_20D_nobeam_comb/post'];
    mkdir(outdir);
    outfilename=['exp/dnn4_pretrain-dbn_dnn/decode_frame_AE_20D_nobeam_comb/post/post.',num2str(job),'.txt'];
