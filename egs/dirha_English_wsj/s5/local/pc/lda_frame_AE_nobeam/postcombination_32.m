...
%  task=tasks{i1};
  weight_file=[weight_dir,'lda_frame_AE_nobeam_comb/weight/stream_weights.scp'];
  ...
  for job=32 
    ...
    outdir=['exp/dnn4_pretrain-dbn_dnn/decode_lda_frame_AE_nobeam_comb/post'];
    mkdir(outdir);
    outfilename=['exp/dnn4_pretrain-dbn_dnn/decode_lda_frame_AE_nobeam_comb/post/post.',num2str(job),'.txt'];
