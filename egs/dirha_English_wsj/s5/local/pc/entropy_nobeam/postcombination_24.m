...
%  task=tasks{i1};
  weight_file=[weight_dir,'entropy_nobeam_comb/weight/stream_weights.scp'];
  ...
  for job=24 
    ...
    outdir=['exp/dnn4_pretrain-dbn_dnn/decode_entropy_nobeam_comb/post'];
    mkdir(outdir);
    outfilename=['exp/dnn4_pretrain-dbn_dnn/decode_entropy_nobeam_comb/post/post.',num2str(job),'.txt'];
