...
if $apply_exp; then
  output_wspecifier="ark:| copy-matrix --apply-exp ark:- ark,t,scp:$dir/output.JOB.txt,$dir/output.JOB.scp"
else
  output_wspecifier="ark:| copy-feats --compress=$compress ark:- ark,t,scp:$dir/output.JOB.txt,$dir/output.JOB.scp"
fi
