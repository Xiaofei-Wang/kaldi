...
$cmd JOB=1:$nj $logdir/make_pca_transf.JOB.log \
  ...
  compute-cmvn-stats --spk2utt=ark:${sdata}/JOB/spk2utt scp:\$tmp_dir/pca_transf_$name.JOB.scp \
  ...
  ${aann_dir}/final.nnet "ark,s,cs:copy-feats scp:\$tmp_dir/pca_transf_$name.JOB.scp ark:- | apply-cmvn --norm-means=true --norm-vars=true --utt2spk=ark:${sdata}/JOB/utt2spk scp:\$tmp_dir/pca_transf_$name.JOB.cmvn.scp ark:- ark:- |" "ark,s,cs:copy-feats scp:\$tmp_dir/pca_transf_$name.JOB.scp ark:- | apply-cmvn --norm-means=true --norm-vars=true --utt2spk=ark:${sdata}/JOB/utt2spk scp:\$tmp_dir/pca_transf_$name.JOB.cmvn.scp ark:- ark:- | nnet-forward ${aann_dir}/final.feature_transform ark:- ark:- | feat-to-post ark:- ark:- |" ark:- \| \
