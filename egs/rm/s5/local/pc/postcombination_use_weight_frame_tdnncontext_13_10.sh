...
utils/queue.pl -l arch=*64 -sync no --mem 20G --gpu 0 -tc 25 JOB=1:100 $log/post_tdnncontext_13_10.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnncontext_13_10/postcombination_use_frame_tdnncontext_13_10_JOB.m
