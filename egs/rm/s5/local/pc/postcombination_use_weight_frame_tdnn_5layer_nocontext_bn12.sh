...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 25 JOB=1:100 $log/post_tdnn_5layer_nocontext_bn12.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnn_5layer_nocontext_bn12/postcombination_use_frame_tdnn_5layer_nocontext_bn12_JOB.m
