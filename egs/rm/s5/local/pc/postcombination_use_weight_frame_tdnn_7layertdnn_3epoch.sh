...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 25 JOB=1:100 $log/frame_tdnn_7layertdnn_3epoch.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnn_7layertdnn_3epoch/postcombination_use_frame_tdnn_7layertdnn_3epoch_JOB.m
