...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 20 JOB=1:100 $log/frame_tdnn_max.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnn_max/postcombination_use_frame_tdnn_max_JOB.m
