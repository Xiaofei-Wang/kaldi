...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 10 JOB=1:100 $log/post_entropy.JOB.log \
  matlab -singleCompThread \< local/pc/entropy/postcombination_use_entropy_JOB.m
