...
utils/queue.pl -l arch=*64 -sync no --mem 10G --gpu 0 -tc 25 JOB=1:100 $log/post_AE4best.JOB.log \
  matlab -singleCompThread \< local/pc/AE4best/postcombination_use_AE4best_JOB.m
