...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 25 JOB=1:100 $log/post_entropy_14ch.JOB.log \
  matlab -singleCompThread \< local/pc/entropy_14ch/postcombination_use_entropy_14ch_JOB.m
