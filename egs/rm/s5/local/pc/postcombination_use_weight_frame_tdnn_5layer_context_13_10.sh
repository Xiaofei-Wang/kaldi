...
utils/queue.pl -l arch=*64 -sync no --mem 20G --gpu 0 -tc 25 JOB=1:100 $log/post_tdnn_5layer_context_13_10.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnn_5layer_context_13_10/postcombination_use_frame_tdnn_5layer_context_13_10_JOB.m
