...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 20 JOB=1:100 $log/post_autoenc.JOB.log \
  matlab -singleCompThread \< local/pc/frame_AE/postcombination_use_autoencoder_JOB.m
