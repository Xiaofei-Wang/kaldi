...
utils/queue.pl -l arch=*64 -sync no --mem 20G --gpu 0 -tc 25 JOB=1:100 $log/post_tdnn_5layertdnn_context_5_5.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnn_5layertdnn_context_5_5/postcombination_use_frame_tdnn_5layertdnn_context_5_5_JOB.m
