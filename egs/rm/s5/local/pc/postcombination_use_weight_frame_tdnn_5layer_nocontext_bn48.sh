...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 20 JOB=1:100 $log/post_tdnn_5layer_nocontext_bn48.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnn_5layer_nocontext_bn48/postcombination_use_frame_tdnn_5layer_nocontext_bn48_JOB.m
