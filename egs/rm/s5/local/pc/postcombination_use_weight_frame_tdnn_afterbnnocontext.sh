...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 25 JOB=1:100 $log/afterbnnocontext.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnn_afterbnnocontext/postcombination_use_frame_tdnn_afterbnnocontext_JOB.m
