...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 25 JOB=1:100 $log/post_tdnn_AE_4epoch_plus.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnn_4epoch_plus/postcombination_use_frame_tdnn_4epoch_plus_JOB.m
