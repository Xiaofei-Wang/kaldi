...
utils/queue.pl -l arch=*64 -sync no --mem 10G --gpu 0 -tc 20 JOB=1:100 $log/post_pca4best.JOB.log \
  matlab -singleCompThread \< local/pc/pca4best/postcombination_use_pca4best_JOB.m
