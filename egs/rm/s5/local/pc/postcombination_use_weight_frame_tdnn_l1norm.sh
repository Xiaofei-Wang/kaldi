...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 28 JOB=1:100 $log/post_tdnn_AE_l1norm.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnn_l1norm/postcombination_use_frame_tdnn_l1norm_JOB.m
