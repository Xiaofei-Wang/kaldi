...
utils/queue.pl -l arch=*64 -sync no --mem 10G --gpu 0 -tc 20 JOB=1:100 $log/post_subsum.JOB.log \
  matlab -singleCompThread \< local/pc/subsum/postcombination_subsum_JOB.m
