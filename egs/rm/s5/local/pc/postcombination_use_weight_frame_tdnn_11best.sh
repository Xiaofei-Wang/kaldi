...
utils/queue.pl -l arch=*64 -sync no --mem 25G --gpu 0 -tc 25 JOB=1:100 $log/frame_tdnn_11best.JOB.log \
  matlab -singleCompThread \< local/pc/frame_tdnn_11best/postcombination_use_frame_tdnn_11best_JOB.m
