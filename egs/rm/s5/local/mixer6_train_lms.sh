...
Train language models for MIXER-6 and optionally for Switchboard, Fisher and web-data from University of Washington.\n
options: 
...
lexicon=$2  # data/ihm/dict/lexicon.txt
dir=$3      # data/local/lm
...
ngram-count -text $dir/train.gz -order $order -limit-vocab -vocab $dir/wordlist \
  -unk -map-unk "<unk>" -wbdiscount -interpolate -lm $dir/mixer6.o${order}g.kn.gz
echo "PPL for MIXER-6 LM:"
ngram -unk -lm $dir/mixer6.o${order}g.kn.gz -ppl $dir/train.gz
ngram -unk -lm $dir/mixer6.o${order}g.kn.gz -ppl $dir/train.gz -debug 2 >& $dir/ppl2
mix_ppl="$dir/ppl2"
mix_tag="mixer6"
mix_lms=( "$dir/mixer6.o${order}g.kn.gz" )
num_lms=1
...
if [ ! -z "$fisher" ]; then
  ...
  ngram -unk -lm $dir/fisher/fisher.o${order}g.kn.gz -ppl $dir/train.gz
  ngram -unk -lm $dir/fisher/fisher.o${order}g.kn.gz -ppl $dir/train.gz -debug 2 \
   >& $dir/fisher/ppl2
...
if [ $num_lms -gt 1  ]; then
  ...
  ngram -unk -lm $dir/${mix_tag}.o${order}g.kn.gz -ppl $dir/train.gz
fi
